...
def makeEdsMaxPxSpc(si, edsEvCh, edsZeOf, npChan=0):
	...
	edsEvCh: float - The eV per channel for the detector (to keV inside).
	edsZeOf: float - The zero offset for the detector in eV (to keV...)
	npChan: int - number of channels to set to zero for the noise peak. Defaults to zero. 
